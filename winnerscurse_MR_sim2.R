## WINNER'S CURSE MR SIMULATION STUDY SCRIPT 2:
...
## the original form of these methods, when the observed correlation is 0.15 -
## it is smaller in magnitude than the causal effect
...
write.csv(summary_results_ivw, "compare_ivw_20sim_2.csv")
...
write.csv(summary_results_ivw_long, "compare_ivw_20sim_long_2.csv")
...
write.csv(summary_results_egger, "compare_egger_20sim_2.csv")
...
write.csv(summary_results_egger_long, "compare_egger_20sim_long_2.csv")
...
write.csv(summary_results_med, "compare_med_20sim_2.csv")
...
write.csv(summary_results_med_long, "compare_med_20sim_long_2.csv")
...
write.csv(summary_results_raps, "compare_raps_20sim_2.csv")
...
write.csv(summary_results_raps_long, "compare_raps_20sim_long_2.csv")
...
write.csv(summary_results_wc_all, "degreee_wc_20sim_2.csv")

################################################################################
################################################################################

write.csv(res_egger[[21]]$data, "bad_egger_example_2.csv")
